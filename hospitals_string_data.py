...
from hospitals_data import generate_nearest_hospitals_DATA

# # storing hospitals data
stored_hospitals_data = generate_nearest_hospitals_DATA()
...
# Equivalent data
# stored_hospitals_data = [{'1name': ('Ruby Hall Clinic',),
...
# pprint(stored_hospitals_data)
def generate_hospitals_Data_to_HTML():
    ...
    for item in stored_hospitals_data:
